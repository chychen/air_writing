...
{
    public class PinchGo : MonoBehaviour
    {
...
/// </summary>
        ...
        void Awake()
        {
            ...
            {
                Debug.LogWarning("No pinch detectors were specified!  PinchGo can not draw any lines without PinchDetectors.");
            }
        }
        ...
        {
            target.GetComponent<TextMesh>().text = result;
        }
        ...
        void FixedUpdate()
        {
            ...
            if (this.flg == 1 && Input.GetKey(KeyCode.S))
            {
                ...
                // TODO
                Thread socketThread = new Thread(new ParameterizedThreadStart(SetupServerAndSend));
                socketThread.Start((object)SB.ToString());
